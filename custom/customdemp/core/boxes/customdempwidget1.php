...
/**
 * \file    customdemp/core/boxes/customdempwidget1.php
 * \ingroup customdemp
 * \brief   Widget provided by CustomDemp
 *
 ...
 */
class customdempwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "customdempbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "customdemp@customdemp";
	 ...
	 */
	public $depends = array('customdemp');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "customdemp@customdemp"));
		...
		// $this->hidden = !$user->hasRight('customdemp', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/customdemp/class/customdemp.class.php");

		// Populate the head at runtime
		$text = $langs->trans("CustomDempBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_customdemp@customdemp',
